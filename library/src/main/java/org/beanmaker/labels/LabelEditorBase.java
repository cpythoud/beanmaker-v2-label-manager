...
@Generated(value = "org.beanmaker.v2.codegen.BeanEditorBaseSourceFile", date = "2024-08-21T16:32:35.156143300Z", comments = "DO-NOT-EDIT,2.2-SNAPSHOT")
abstract class LabelEditorBase extends DbBeanEditor {
	...
	List<Function<DBTransaction, FieldValidationResult>> getNameValidationFunctions() {
		return List.of(transaction -> {
			...
			return FieldValidationResult.create("name" + DbBeanLocalization.TOO_LONG_EXT, 128);
		});
	}
